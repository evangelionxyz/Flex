...
namespace flex
{
    ...
    public:
        ...
        bool CreateBody(JPH::ShapeRefC shape, entt::entity entity, const glm::vec3 &position, const glm::quat &rotation, bool isPlane = false);

        void CreateBoxCollider(entt::entity entity);
        void CreateSphereCollider(entt::entity entity);
        void CreateCapsuleCollider(entt::entity entity);
        void CreatePlaneCollider(entt::entity entity);
