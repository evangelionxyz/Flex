...
void Camera::UpdateMouseState(GLFWwindow *window)
{
...
void Camera::HandlePan(float deltaTime)
{
	if (mouse.middleButton) {
		...
		float panSpeed = controls.panSensitivity * distance;
...
void Camera::HandleZoom(float deltaTime, GLFWwindow *window)
{
	// Handle mouse wheel
